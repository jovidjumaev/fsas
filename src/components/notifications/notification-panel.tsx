    ...
    <div className="relative" ref={panelRef}>
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed md:absolute right-2 md:right-0 top-16 md:top-auto md:mt-2 w-[calc(100vw-1rem)] md:w-96 max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
            {/* Header */}
