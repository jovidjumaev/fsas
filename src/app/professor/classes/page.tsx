...
function ClassesPageContent() {
  ...
  const handleCreateClass = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // logger.debug('Class created successfully:', result);
  ...
  const fetchUserProfile = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        // logger.debug('🔍 Falling back to user metadata');
        ...
        // logger.debug('🔍 Using fallback profile:', fallbackProfile);
  ...
  const handleProfileSave = async (profileData: any) => {
    ...
    try {
      // logger.debug('Attempting to save profile data:', profileData);
      ...
      if (namesChanged) {
        // logger.debug('Names changed, checking name change limits...');
        ...
        // logger.debug('Name change recorded successfully:', nameChangeResult);
      }
