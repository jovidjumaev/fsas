...
2. **Replace the HTML body** with this template:
...
<body>
    <div class="container">
        ...
        <p class="message">
            Hello,<br><br>
            You requested to reset your password for your FSAS account. Use the code below to reset your password:
        </p>
        ...
        <div class="important-section">
            ...
            <ul class="important-list">
                ...
                <li>For security reasons, this code can only be used <strong>once</strong></li>
...
1. **Uses `{{ .Token }}`** instead of `{{ .ConfirmationURL }}` for the code
2. **Shows the 6-digit code** prominently
3. **Still includes the confirmation URL** for the reset page
4. **Updated expiry message** to 1 hour (OTP default)

## Benefits of OTP:

1. **Configurable expiry** (default 1 hour, can be changed)
2. **Better user experience** - clear 6-digit code
3. **More reliable** than Magic Links
4. **Works on Free plan** with better expiry control
